 ...
 * @param v
 */
void winternitz_4_keygen(const unsigned char s[/*m*/], const unsigned short m, sponge_t *priv, sponge_t *hash, sponge_t *pubk, unsigned char v[/*m*/]) {
    //int sq = 0;
    unsigned char i, j;
 ...
 * @param v
 */
void winternitz_8_keygen(const unsigned char s[/*m*/], const unsigned short m, sponge_t *priv, sponge_t *hash, sponge_t *pubk, unsigned char v[/*m*/]) {
    //int sq = 0;
    unsigned char i, j;
...
#elif WINTERNITZ_W == 4
    winternitz_4_keygen(s, m, priv, hash, pubk, v);
#elif WINTERNITZ_W == 8
    winternitz_8_keygen(s, m, priv, hash, pubk, v);
#endif
}
 ...
 * @param sig
 */
void winternitz_2_sign(const byte s[/*m*/], const byte v[/*m*/], const uint m, const byte *M, uint len, sponge_t *hash, byte h[/*m*/], byte sig[/*4*(m+1)*m*/] /* 4*(m+1) m-byte blocks */) {
    //int sq = 0;
    byte i;
    uint seclevel = m << 3;
    uint checksum = 0;
 ...
 * @param sig
 */
void winternitz_2_sign(const unsigned char s[/*m*/], const unsigned char v[/*m*/], const unsigned short m, const unsigned char *M, unsigned short len, sponge_t *hash, unsigned char h[/*m*/], unsigned char sig[/*4*(m+1)*m*/] /* 4*(m+1) m-byte blocks */) {
    //int sq = 0;
    unsigned char i;
 ...
 * @param sig
 */
void winternitz_4_sign(const unsigned char s[/*m*/], const unsigned char v[/*m*/], const unsigned short m, const unsigned char *M, unsigned short len, sponge_t *priv, sponge_t *hash, unsigned char h[/*m*/], unsigned char sig[/*(2*m+3)*m*/] /* 2m+3 m-unsigned char blocks */) {
    //int sq = 0;
    unsigned char i, j, c;
    unsigned short checksum = 0;
 ...
 * @param sig
 */
void winternitz_8_sign(const unsigned char s[/*m*/], const unsigned char v[/*m*/], const unsigned short m, const unsigned char *M, unsigned short len, sponge_t *priv, sponge_t *hash, unsigned char h[/*m*/], unsigned char sig[/*(m+2)*m*/] /* m+2 m-unsigned char blocks */) {
...
#elif WINTERNITZ_W == 4
    winternitz_4_sign(s, v, m, M, len, priv, hash, h, sig);
#elif WINTERNITZ_W == 8
    winternitz_8_sign(s, v, m, M, len, priv, hash, h, sig);
#endif
}
 ...
 */
bool winternitz_2_verify(const byte v[/*m*/], const uint m, const byte *M, uint len, sponge_t *pubk, sponge_t *hash, byte h[/*m*/], const byte sig[/*(2*m+3)*m*/] /* 2m+3 m-byte blocks */, byte x[/*m*/]) {
    //int sq = 0;
    byte i, j, c;
    uint seclevel = m << 3;
    uint checksum = 0;
 ...
 * @param x scratch (should match v at the end)
 */
unsigned char winternitz_4_verify(const unsigned char v[/*m*/], const unsigned short m, const unsigned char *M, unsigned short len, sponge_t *pubk, sponge_t *hash, unsigned char h[/*m*/], const unsigned char *sig, unsigned char *x) {
    //int sq = 0;
    unsigned char i, j, c;
    unsigned short checksum = 0;
 ...
 * @param x scratch (should match v at the end)
 */
unsigned char winternitz_8_verify(const unsigned char v[/*m*/], const unsigned short m, const unsigned char *M, unsigned short len, sponge_t *pubk, sponge_t *hash, unsigned char h[/*m*/], const unsigned char sig[/*(m+2)*m*/] /* m+2 m-unsigned char blocks */, unsigned char x[/*m*/]) {
    //int sq = 0;
    unsigned char i, j;
    unsigned short c, checksum = 0;
    sinit(hash, WINTERNITZ_SEC_LVL);
...
unsigned char winternitz_verify(const unsigned char v[], const unsigned short m, const unsigned char *M, unsigned short len, sponge_t *pubk, sponge_t *hash, unsigned char h[], const unsigned char sig[], unsigned char *x) {
#if WINTERNITZ_W == 2
...
int main(int argc, char *argv[]) {
    ...
    for (test = 0; test < tests; test++) {
        winternitz_keygen(s, m, &priv, &hash, &pubk, v);
    }
    elapsed += clock();
    ...
    elapsed = -clock();
     for (test = 0; test < tests; test++) {
        winternitz_sign(s, v, m, (const unsigned char *)M, strlen(M)+1, &priv, &hash, h, sig);
    }
    elapsed += clock();
    printf("Elapsed time: %.1f us\n", 1000000*(float)elapsed/CLOCKS_PER_SEC/tests);
    ...
    elapsed = -clock();
     for (test = 0; test < tests; test++) {
        ok = winternitz_verify(v, m, (const unsigned char *)M, strlen(M)+1, &pubk, &hash, h, sig, x);
    }
    elapsed += clock();
    printf("Elapsed time: %.1f us\n", 1000000*(float)elapsed/CLOCKS_PER_SEC/tests);
